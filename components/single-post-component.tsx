       ...
       <div className="flex flex-col bg-white ">
         <div className="bg-white flex flex-row p-2 ">
           <div className=" w-full flex-wrap flex flex-row ">
             {/* img-div  */}
             <div className="">
               <img  alt="avatar" className=" cursor-pointer aspect-square w-16 h-16 rounded-full mr-2 shadow-sm shadow-black" />
             </div>
             <div className="flex flex-col p-4 ">
             <h3 className="w-full font-bold text-sm mb-1">
                 {(post.author === undefined ? "unknown" : props.author.name)}
               </h3>
         ...
         <div className="px-4">
           <div className="">
             ...
             <div className="flex   flex-col justify-between text-justify py-3">
               <div>
                 <p className="line-clamp-2 mb-5">{props.body}</p>
               </div>
               <div className="flex justify-end text-blue-600 font-semibold">
                 {(user.data._id == "") &&   
                  <Link href = {{
                        pathname:`/single-post-detailed` ,
                  ...
                  <Link href = {{
                        pathname:`/single-post-detailed` ,
                        query: { postId: props._id ,userId : user.data._id },
                        }}> مشاهده
                  </Link> 
                   } 
              </div>
